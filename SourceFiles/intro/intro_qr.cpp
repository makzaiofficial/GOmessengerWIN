...
void QrWidget::setupControls() {
	...
	const auto texts = {
		QString::fromUtf8("Шаг 1: Сканируйте QR-код с другого устройства c GOmessenger."),
		QString::fromUtf8("Шаг 2: Подтвердите вход на другом устройстве GOmessenger."),
		QString::fromUtf8("Шаг 3: Наслаждайтесь использованием."),
	};
	auto index = 0;
	for (const auto& text : texts) {
		const auto label = steps->add(
			object_ptr<Ui::FlatLabel>(
				steps,
				text, // Передаем QString напрямую
				st::introQrStep),
